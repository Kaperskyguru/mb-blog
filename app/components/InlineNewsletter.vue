<template>
  <div class="mt-5 mb-5 w-full max-w-2xl mx-auto bg-white shadow rounded p-6">
    <div class="space-y-4">
      <!-- Title -->
      ...
      <!-- Success Message -->
      <div id="ck_success_msg" class="hidden text-green-600 text-center">
        <p>Success! Now check your email to confirm your subscription.</p>
      </div>

      <!-- Form -->
      <form id="ck_subscribe_form" @submit.prevent="submit" class="w-full">
        <!-- Error Message -->
        <div class="mb-3">
          <div
            id="ck_error_msg"
        ...
        <div class="flex flex-col md:flex-row gap-3 p-2">
          <input
            ...
            type="email"
            name="email"
            class="flex-1 px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-indigo-500 focus:outline-none"
      ...
      <!-- Guarantee -->
      <span class="block text-xs text-gray-500 text-center">
